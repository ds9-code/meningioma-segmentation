...
def computeDiceScores(pred, ground):
    ...
    d_3 = diceFunction(pred==3, ground==3)#do not need this label
    d_4 = diceFunction(pred==4, ground==4)#do not need this label
...
print('start')
for i in range(total_patients): #add to spreadsheet
        print(f'{i}\n')
        ...
        #cid_array = file_name.split('_')
        #cid = cid_array[1] + "_" + cid_array[2]
        cid_array = file_name.split('.')
        cid = cid_array[0]
        print(cid)
        patient_IDs.append(cid)
...
validation_summary_file = '/content/drive/MyDrive/nnUNet/summary_statistics_validation.csv'
header = [
        'Region',
...
test_summary_file = '/content/drive/MyDrive/nnUNet/summary_statistics_test.csv'
header = [
        'Region',
        'Dice (mean)', 'Dice (median)', 'Dice (std)', 
        'Sensitivity (mean)', 'Sensitivity (median)', 'Sensitivity (std)',
