...
if __name__ == '__main__':
    ...
    total_patients = num_train + num_test

    # cfg files containing file paths
    # these were generated by the generate script in the train folder

    ground_truth_segmentations = '/content/drive/MyDrive/nnUNet/gt.cfg'
    predicted_segmentations = '/content/drive/MyDrive/nnUNet/predictions.cfg'
    ...
    train_summary_file = 'summary_statistics_training.csv'
    header = [
        'Region',
    ...
    train_data = [
        ...
        ['Cystic Component',
        np.nanmean(dice_stats[3][0:num_train]), np.nanmedian(dice_stats[3][0:num_train]), np.nanstd(dice_stats[3][0:num_train]),
        np.nanmean(sensitivity_stats[3][0:num_train]), np.nanmedian(sensitivity_stats[3][0:num_train]), np.nanstd(sensitivity_stats[3][0:num_train]),
        np.nanmean(hd_stats[3][0:num_train]), np.nanmedian(hd_stats[3][0:num_train]), np.nanstd(hd_stats[3][0:num_train])],
        ['Edema',
        np.nanmean(dice_stats[4][0:num_train]), np.nanmedian(dice_stats[4][0:num_train]), np.nanstd(dice_stats[4][0:num_train]),
        np.nanmean(sensitivity_stats[4][0:num_train]), np.nanmedian(sensitivity_stats[4][0:num_train]), np.nanstd(sensitivity_stats[4][0:num_train]),
        np.nanmean(hd_stats[4][0:num_train]), np.nanmedian(hd_stats[4][0:num_train]), np.nanstd(hd_stats[4][0:num_train])],
        ['NET+C+Ed',
        np.nanmean(dice_stats[5][0:num_train]), np.nanmedian(dice_stats[5][0:num_train]), np.nanstd(dice_stats[5][0:num_train]),
        np.nanmean(sensitivity_stats[5][0:num_train]), np.nanmedian(sensitivity_stats[5][0:num_train]), np.nanstd(sensitivity_stats[5][0:num_train]),
        np.nanmean(hd_stats[5][0:num_train]), np.nanmedian(hd_stats[5][0:num_train]), np.nanstd(hd_stats[5][0:num_train])]
    ]
    ...
    test_data = [
        ['Whole Tumor',
        np.nanmean(dice_stats[0][num_train:total_patients]), np.nanmedian(dice_stats[0][num_train:total_patients]), np.nanstd(dice_stats[0][num_train:total_patients]),
        np.nanmean(sensitivity_stats[0][num_train:total_patients]), np.nanmedian(sensitivity_stats[0][num_train:total_patients]), np.nanstd(sensitivity_stats[0][num_train:total_patients]),
        np.nanmean(hd_stats[0][num_train:total_patients]), np.nanmedian(hd_stats[0][num_train:total_patients]), np.nanstd(hd_stats[0][num_train:total_patients])],
        ['Enhancing Core',
        np.nanmean(dice_stats[1][num_train:total_patients]), np.nanmedian(dice_stats[1][num_train:total_patients]), np.nanstd(dice_stats[1][num_train:total_patients]),
        np.nanmean(sensitivity_stats[1][num_train:total_patients]),  np.nanmedian(sensitivity_stats[1][num_train:total_patients]), np.nanstd(sensitivity_stats[1][num_train:total_patients]),
        np.nanmean(hd_stats[1][num_train:total_patients]), np.nanmedian(hd_stats[1][num_train:total_patients]), np.nanstd(hd_stats[1][num_train:total_patients])],
        ['Non-Enhancing Core',
        np.nanmean(dice_stats[2][num_train:total_patients]), np.nanmedian(dice_stats[2][num_train:total_patients]), np.nanstd(dice_stats[2][num_train:total_patients]),
        np.nanmean(sensitivity_stats[2][num_train:total_patients]), np.nanmedian(sensitivity_stats[2][num_train:total_patients]), np.nanstd(sensitivity_stats[2][num_train:total_patients]),
        np.nanmean(hd_stats[2][num_train:total_patients]), np.nanmedian(hd_stats[2][num_train:total_patients]), np.nanstd(hd_stats[2][num_train:total_patients])],
        ['Cystic Component',
        np.nanmean(dice_stats[3][num_train:total_patients]), np.nanmedian(dice_stats[3][num_train:total_patients]), np.nanstd(dice_stats[3][num_train:total_patients]),
        np.nanmean(sensitivity_stats[3][num_train:total_patients]), np.nanmedian(sensitivity_stats[3][num_train:total_patients]), np.nanstd(sensitivity_stats[3][num_train:total_patients]),
        np.nanmean(hd_stats[3][num_train:total_patients]), np.nanmedian(hd_stats[3][num_train:total_patients]), np.nanstd(hd_stats[3][num_train:total_patients])],
        ['Edema',
        np.nanmean(dice_stats[4][num_train:total_patients]), np.nanmedian(dice_stats[4][num_train:total_patients]), np.nanstd(dice_stats[4][num_train:total_patients]),
        np.nanmean(sensitivity_stats[4][num_train:total_patients]), np.nanmedian(sensitivity_stats[4][num_train:total_patients]), np.nanstd(sensitivity_stats[4][num_train:total_patients]),
        np.nanmean(hd_stats[4][num_train:total_patients]), np.nanmedian(hd_stats[4][num_train:total_patients]), np.nanstd(hd_stats[4][num_train:total_patients])],
        ['NET+C+Ed',
        np.nanmean(dice_stats[5][num_train:total_patients]), np.nanmedian(dice_stats[5][num_train:total_patients]), np.nanstd(dice_stats[5][num_train:total_patients]),
        np.nanmean(sensitivity_stats[5][num_train:total_patients]), np.nanmedian(sensitivity_stats[5][num_train:total_patients]), np.nanstd(sensitivity_stats[5][num_train:total_patients]),
        np.nanmean(hd_stats[5][num_train:total_patients]), np.nanmedian(hd_stats[5][num_train:total_patients]), np.nanstd(hd_stats[5][num_train:total_patients])]
    ]
