...
nnUNet_predict -i $nnUNet_raw_data_base/nnUNet_raw_data/Task501_Meningioma/imagesTr/ -o $nnUNet_raw_data_base/t501_train_inference -t 501 -m 3d_fullres --save_npz
